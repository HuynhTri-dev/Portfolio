  ...
  return (
    <section className="py-10 border-b border-gray-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Junior Support */}
        <div className="bg-[#1E293B]/40 backdrop-blur-md p-6 rounded-xl border border-white/10 hover:-translate-y-2 hover:border-[var(--dev-primary)] transition-all duration-300 group shadow-lg">
          <div className="flex items-center gap-2 mb-4">
            <Coffee className="w-6 h-6 text-[var(--dev-accent)]" />
            <h3 className="text-xl font-bold text-[var(--dev-text)]">
              Junior Support
            </h3>
          </div>
          <div className="text-2xl font-bold text-[var(--dev-accent)] mb-4">
            1k - 50k
          </div>
          <p className="text-gray-400 mb-6 min-h-[48px]">
            Giúp Dev tỉnh táo thêm 2 giờ. Bạn nhận được một lời cảm ơn thầm lặng
            trong git commit log.
          </p>
          <button
        ...
        {/* Senior Sponsor */}
        <div className="bg-[#1E293B]/40 backdrop-blur-md p-6 rounded-xl border border-white/10 hover:-translate-y-2 hover:border-[var(--dev-primary)] transition-all duration-300 relative group shadow-lg">
          ...
          <p className="text-gray-400 mb-6 min-h-[48px]">
            Đóng góp quỹ mua Switch bàn phím. Giúp Dev gõ code nhanh hơn, fix
            bug lẹ hơn (hy vọng thế).
          </p>
          <button
        ...
        <div className="bg-[#1E293B]/40 backdrop-blur-md p-6 rounded-xl border border-white/10 hover:-translate-y-2 hover:border-[var(--dev-primary)] transition-all duration-300 group shadow-lg">
          ...
          <p className="text-gray-400 mb-6 min-h-[48px]">
            Bạn là ánh sáng của Đảng! Số tiền này dùng để mua Claude Pro hoặc
            trả tiền AWS lỡ quên tắt instance.
          </p>
          <button
